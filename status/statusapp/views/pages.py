...
def index(request, sort_filter):
    ...
    total_counts = active_relays.aggregate(
                   bandwidthavg=Sum('bandwidthavg'),
                   bandwidthburst=Sum('bandwidthburst'),
                   bandwidthobserved=Sum('bandwidthobserved'))
    ...
    if query_options:
        active_relays = filter_active_relays(
                active_relays, query_options)
    ...
    # -----------------------------------------------------------------
    counts = active_relays.aggregate(
    ...
    html_table_rows = generate_table_rows(
            active_relays, current_columns, html_current_columns)
    ...
    template_values = {'relay_list': active_relays,
